...
public class NumeroUtil {
	...
	public static double strDouble(String strNumero){
		double numero = 0;
		if(!strNumero.equals("")){
			numero = Double.parseDouble(strNumero.replace(",", "."));
		}
		return numero;
	}
	
	public static float strFloat(String strNumero){
		float numero = Float.parseFloat(strNumero.replace(",", "."));
		return numero;
	}
	
	public static String strExtenso(double num){
		NumeroUtil teste = new NumeroUtil(new BigDecimal(num));
     ...
     * @since JDK 1.5
     */
    public NumeroUtil(BigDecimal dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
     ...
     * @since JDK 1.5
     */
    public NumeroUtil(double dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
