...
public class TesteNumExtenso {
     ...
     * @since JDK 1.5
     */
    public TesteNumExtenso(BigDecimal dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
     ...
     * @since JDK 1.5
     */
    public TesteNumExtenso(double dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
    ...
    public static void main(String[] args) throws NumberFormatException {
        ...
        System.out.println("Extenso : " + NumeroUtil.strExtenso(teste).toUpperCase());
    }
