       ...
       <%@include file="../topo.jsp" %>
		...
		<c:if test="${not empty erro }">
            ...
            <div class="row">
                ...
                <div class="row">
          		<div class="col-lg-12">
          			<h4>Digite a placa do veículo</h4>
          			...
          			<div class="row">
          				<div class="form-group col-lg-6">
          					<input type="text" class="form-control" name="placa" maxlength="7" placeholder="Placa - ex: AAA0000">
          				</div>
          			</div>
          			<div class="row">
          				<div class="form-group col-lg-6">
          					<input type="text" class="form-control" name="renavam" placeholder="Renavam">
          					<small>*Obs: Não é necessário preencher placa e renavam.</small>
          				</div>
          			</div>
          			<div class="row">
          				<div class="form-group col-lg-6">
