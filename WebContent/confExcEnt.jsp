...
<div class="modal fade" id="ModalConfEntExc${ent.codigo }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
    			  <div class="modal-header">
    			    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    			    <h4 class="modal-title" id="myModalLabel">Excluir entrada</h4>
    			  </div>
    			  	<form action="caixa" method="post">
    			  <div class="modal-body">
        	
        				<input type="hidden" name="acao" value="deletarEntrada">
